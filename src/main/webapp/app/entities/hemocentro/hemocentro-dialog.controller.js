(function() {
    ...
    HemocentroDialogController.$inject = ['$timeout', '$scope', '$stateParams', '$uibModalInstance', 'entity', 'Hemocentro'];

    function HemocentroDialogController ($timeout, $scope, $stateParams, $uibModalInstance, entity, Hemocentro) {
        var vm = this;
