...
/**
 * Performance test for the Funcionamento entity.
 */
class FuncionamentoGatlingTest extends Simulation {
    ...
    val scn = scenario("Test the Funcionamento entity")
        ...
        .pause(10)
        .repeat(2) {
            exec(http("Get all funcionamentos")
            .get("/api/funcionamentos")
            .headers(headers_http_authenticated)
            .check(status.is(200)))
            ...
            .pause(10)
            .repeat(5) {
                exec(http("Get created funcionamento")
                .get("${new_funcionamento_url}")
                .headers(headers_http_authenticated))
                .pause(10)
            }
            .exec(http("Delete created funcionamento")
            .delete("${new_funcionamento_url}")
            .headers(headers_http_authenticated))
            .pause(10)
        }
